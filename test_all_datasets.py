...
if __name__ == '__main__':
    ...
    # paths
    parser.add_argument("--test_data_path", type=str, default=os.path.join(datasets_root, dataset_names[0]), help="path to test dataset")
    ...
    # model
    parser.add_argument("--dataset", type=str, default=dataset_names[0])
